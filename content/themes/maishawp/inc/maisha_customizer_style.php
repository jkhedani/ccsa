...
function maisha_customizer_css() {
    ...
    <style type="text/css">
		...
		button,input[type="button"], input[type="reset"], input[type="submit"], .widget_calendar tbody a, .page-template-projects-page .columns hr, .page-template-causes-page .columns hr, .page-template-stories-page .columns hr { background-color:<?php echo get_theme_mod( 'maisha_button_colors' ); ?>; }
		...
		.pagination .prev,.pagination .next,.tagcloud a,.sticky-post,.page-links a,.cd-panel-container,.aboutpage .cd-fixed-bg-one,.aboutpage .cd-fixed-bg-one.withoutimg { background-color:<?php echo get_theme_mod( 'maisha_dark_button_colors' ); ?>; }
