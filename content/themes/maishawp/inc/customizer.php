...
*/
	...
	$wp_customize->add_control( 'maisha_projects_layout', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'top-header'   => 'Top Content Block',
			'no-header'  => 'Without Top Content Block',
		)
	) );
...
*/
	...
	$wp_customize->add_control( 'maisha_causes_layout', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'top-header-one'   => 'Top Content Block',
			'no-header-one'  => 'Without Top Content Block',
		)
	) );
...
*/
	...
	$wp_customize->add_control( 'maisha_stories_layout', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'top-header-two'   => 'Top Content Block',
			'no-header-two'  => 'Without Top Content Block',
		)
	) );
...
*/
	...
	$wp_customize->add_control( 'maisha_blog_layout', array(
		...
		'choices'           => array(
			...
			'grid-right'  => 'Grid Layout + Right Sidebar',
			'grid-left'  => 'Grid Layout + Left Sidebar',
			'grid-full'  => 'Full Grid Layout',
			'list'  => 'List Layout',
		)
	) );
	...
	$wp_customize->add_control( 'maisha_post_type', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'full-lenght'   => 'Full Lenght',
			'excerpt-lenght'  => 'Excerpt',
		)
	) );
	...
	$wp_customize->add_control( 'maisha_single_post_layout', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'single-full'   => 'Full Post Layout',
			'single-sidebar-right'  => 'Right Sidebar Layout',
			'single-sidebar-left'  => 'Left Sidebar Layout',
		)
	) );
	...
	$wp_customize->add_control( 'maisha_archive_layout', array(
		...
		'type'              => 'radio',
		'choices'           => array(
			'archive-full'   => 'Full Post Layout',
			'archive-sidebar-right'  => 'Right Sidebar Layout',
			'archive-sidebar-left'  => 'Left Sidebar Layout',
			'archive-grid-right'  => 'Grid Layout + Right Sidebar',
			'archive-grid-left'  => 'Grid Layout + Left Sidebar',
			'archive-grid-full'  => 'Full Grid Layout',
